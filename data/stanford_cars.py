...
def get_scars_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
    ...
    #print('in StanfordCars dataset: train_labeled class labels= {}, train_unlabeled class labels= {}'
    #                        .format(set(train_dataset_labelled.target), set(train_dataset_unlabelled.target)))
    return all_datasets
