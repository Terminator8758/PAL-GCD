...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, return_all_patches=False):
        ...
        for i,blk in enumerate(self.blocks):
            x = blk(x)
            #if i==10 and lowlayer_feat:  # i==5
            #    #print('total block num= {}, lowlayer batch feat shape= {}'.format(x.shape, len(self.blocks)))  # shape(128,129,384)
            #    lowlayer_x = x[:, 0]
